 ...
 */
package com.locke.library.web.visitors.error;
...
public class ShowError implements IVisitor<Component>, Serializable {

	private static final long serialVersionUID = 7699039094418323127L;

	private final String errorCssClass;

	public ShowError(final String errorCssClass) {
