...
import com.locke.library.web.wow.component.factories.panels.TextFieldPanel;
 ...
 */
public class TextFieldFactory extends AbstractPanelFactory<String> {
	...
	public Panel newComponent(String id) {
		return new TextFieldPanel(id, getModel());
	}
}
