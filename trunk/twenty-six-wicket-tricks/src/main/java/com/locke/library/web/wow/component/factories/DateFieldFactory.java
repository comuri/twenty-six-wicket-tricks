...
import com.locke.library.web.wow.component.factories.panels.DateFieldPanel;
 ...
 */
public class DateFieldFactory extends AbstractPanelFactory<Date> {
	...
	public Panel newComponent(String id) {
		return new DateFieldPanel(id, getModel());
	}
}
