...
import com.locke.library.web.wow.component.factories.panels.IntegerFieldPanel;
 ...
 */
public class IntegerFieldFactory extends AbstractPanelFactory<Integer> {
	...
	public Panel newComponent(String id) {
		return new IntegerFieldPanel(id, getModel());
	}
}
