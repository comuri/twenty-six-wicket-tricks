...
public class BroadcasterPanel extends EventPanel {

	public BroadcasterPanel(String id) {
		super(id);
		add(new Link("send") {

			@Override
			public void onClick() {
				getPageEventBroadcaster().broadcast(
						new ClickEvent(BroadcasterPanel.this));
			}
		});
	}
}
