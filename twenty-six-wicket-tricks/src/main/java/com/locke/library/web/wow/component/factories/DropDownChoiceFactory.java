...
import com.locke.library.web.wow.component.factories.panels.DropDownChoicePanel;
...
public abstract class DropDownChoiceFactory<T> extends
	...
	public Panel newComponent(String id) {
		return new DropDownChoicePanel(id, getModel(), getChoices());
	}
