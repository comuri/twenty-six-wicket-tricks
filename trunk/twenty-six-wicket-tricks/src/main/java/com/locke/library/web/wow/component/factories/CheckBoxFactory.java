...
import com.locke.library.web.wow.component.factories.panels.CheckBoxPanel;
 ...
 */
public class CheckBoxFactory extends AbstractPanelFactory<Boolean> {
	...
	public Panel newComponent(String id) {
		return new CheckBoxPanel(id, getModel());
	}
}
